const description = 'Test site for some game development'
const color = '#b6571f'
const source = 'https://grid.jacobsmith.tech/images/logo-og.png'
// NOTE: This file is included in client. Don't put secrets in here. They go in keys.js

const siteMeta = {
  name: 'Grid',
  short_name: 'Grid', // eslint-disable-line camelcase
  title: 'Grid | Testing game stuffs',
  author: 'Jacob Smith',
  display: 'standalone',
  start_url: '/', // eslint-disable-line camelcase
  // Keep in sync with config.js and serve.js
  host: 'https://grid.jacobsmith.tech',
  description,
  color,
  og: {
    description,
